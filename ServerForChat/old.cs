...
//                     {
//                        // Determine the length of recipient ID
//                         int recipientIdLength = BitConverter.ToInt32(buffer, 0);

//                         // Extract the recipient ID
//                         recipientId = Encoding.UTF8.GetString(buffer, sizeof(int), recipientIdLength);

//                         Console.WriteLine($"Got recipient id: '{recipientId}'.");

//                         // Extract the encrypted message
//                         messageBytes = new byte[bytesRead - sizeof(int) - recipientIdLength];
//                         Buffer.BlockCopy(buffer, sizeof(int) + recipientIdLength, messageBytes, 0, messageBytes.Length);

//                         Console.WriteLine($"Extracted the encrypted message.");
...
//                             Console.WriteLine($"Client '{clientId}' has sent a {messageBytes} to recipient '{recipientId}'.");
//                         }
//                         else
//                         {
